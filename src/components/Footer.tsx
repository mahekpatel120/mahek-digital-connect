      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-muted-foreground mb-6 max-w-md">
              Your growth partner in Digital Marketing, Ecommerce Management, Branding, SEO, and Strategy Execution.
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Home', 'Services', 'Contact', 'About Us'].map((link) => (
                <li key={link}>
                  <Link
          ...
          <div>
            ...
            <div className="space-y-3">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-muted-foreground">8160888687</span>
              </div>
              <div className="flex items-center space-x-3">
                <Mail className="h-4 w-4 text-primary" />
                <span className="text-muted-foreground">mahekpatel0282@gmail.com</span>
              </div>
              <div className="flex items-center space-x-3">
                <MapPin className="h-4 w-4 text-primary" />
                <span className="text-muted-foreground">Digital Marketing Hub</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-border mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-muted-foreground text-sm">
            © 2025 Mahek Enterprises. All rights reserved.
          </p>
